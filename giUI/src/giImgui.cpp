...
//    SharedPtr<SamplerState>                   PSSampler;
...
//  old.BlenState = gapi.omGetBlendState();
//  old.DepthStencilState = gapi.omGetDepthStencilState();
...
//  
//  gapi.rsSetRasterizerState(old.RS); 
//  
...
//  
//  gapi.psSetSamplerState(0, 1, old.PSSampler); 
//  
...
//  io.Fonts->SetTexID((ImTextureID*)bd->spFontTextureView.get());
//
...
//Esta es para multiples viewports
//static void 
//ImGui_ImplGI_CreateWindow(ImGuiViewport* viewport) {
//
//  auto& gapi = g_graphicsAPI();
//
//  ImGui_ImplGI_Data* bd = ImGui_ImplGI_GetBackendData();
...
//}
//
//static void ImGui_ImplGI_DestroyWindow(ImGuiViewport* viewport)
//{
...
//}
//
//static void ImGui_ImplGI_SetWindowSize(ImGuiViewport* viewport, ImVec2 size)
//{
//  ImGui_ImplDX11_Data* bd = ImGui_ImplDX11_GetBackendData();
...
//}
//
//static void ImGui_ImplGI_RenderWindow(ImGuiViewport* viewport, void*)
//{
//  ImGui_ImplDX11_Data* bd = ImGui_ImplDX11_GetBackendData();
//  ImGui_ImplDX11_ViewportData* vd = (ImGui_ImplDX11_ViewportData*)viewport->RendererUserData;
...
//}
//
//static void ImGui_ImplGI_SwapBuffers(ImGuiViewport* viewport, void*)
//{
//  ImGui_ImplDX11_ViewportData* vd = (ImGui_ImplDX11_ViewportData*)viewport->RendererUserData;
